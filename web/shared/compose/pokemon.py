...
# Local Imports
from web.shared.compose.frames import load_or_make_pokemon_frame, pokemon_art_box
...
def compose_pokemon(
    ...
    the whole card (frame + rules text). Custom uploads skip that peel.
    """
    p = _provider(card)
    ...
    art_box = pokemon_art_box(style, trainer=trainer or energy)
